                ...
                <div class="tab-content" id="pills-tabContent">
                    ...
                    <div class="form-row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input name="firstname" type="text" class="form-control" id="validationCustom01" placeholder="First name" value="Mark" required="">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input name="lastname" type="text" class="form-control" id="validationCustom02" placeholder="Last name" value="Otto" required="">
                            <div class="valid-feedback">
                                Looks good!
                            </div>
                        </div>
                    ...
                    <div class="form-row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input name="birthdate" type="date" class="form-control" id="validationCustom01" placeholder="Birth Date" required="">
                            <div class="valid-feedback">
                                Looks good!
                            </div>
                        </div>
                        <div class="col-md-4 mb-3">
                            ...
                            <input name="age" type="number" class="form-control" id="validationCustom02" placeholder="Age" min="18" max="70" required="">
                            <div class="valid-feedback">
                                Looks good!
                            </div>
                        </div>
                    ...
                    <div class="form-row">
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number" value="42" id="example-number-input" name="rate">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" checked="" class="custom-control-input" id="customCheck1" name="benefits[]" value="philhealth">
                                <label class="custom-control-label" for="customCheck1">PHILHEALTH</label>
                            </div>
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" checked="" class="custom-control-input" id="customCheck2" name="benefits[]" value="sss">
                                <label class="custom-control-label" for="customCheck2">SSS</label>
                            </div>
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" checked="" class="custom-control-input" id="customCheck3" name="benefits[]" value="pagibig">
