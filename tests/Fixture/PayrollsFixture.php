...
class PayrollsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'is_thirteen_month_pay' => ['type' => 'boolean', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => 1,
                'bill_date' => '2018-12-18',
                'start_date' => '2018-12-18',
                'end_date' => '2018-12-18',
                'file' => 'Lorem ipsum dolor sit amet',
                'is_thirteen_month_pay' => 1,
                'created' => '2018-12-18 09:02:54',
                'modified' => '2018-12-18 09:02:54'
            ],
        ];
        parent::init();
    }
