...
class ProductsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'sale_percent' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'sale_price' => ['type' => 'float', 'length' => null, 'precision' => null, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => ''],
        'details' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'max_availability_date' => ['type' => 'datetime', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'category_id' => 1,
                'user_id' => 1,
                'created' => '2018-12-03 06:41:15',
                'max_availability_date' => '2018-12-03 06:41:15',
                'modified' => '2018-12-03 06:41:15'
            ],
        ];
        parent::init();
    }
